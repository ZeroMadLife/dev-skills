---
name: logic-lens
description: "Use when reviewing complex code changes, refactoring business logic, or checking security-sensitive paths such as authentication, authorization, SQL, file access, concurrency, and API contracts."
